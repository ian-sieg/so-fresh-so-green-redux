      ...
      <div class="bg-white rounded-lg shadow">
        ...
        <div class="grid grid-cols-4 justify-center">
          <div class="rounded-r-lg py-6 hover:bg-gray-50 cursor-pointer flex items-center justify-center">
            <div class="flex items-center space-x-1 text-gray-900">
              ...
              <button onClick={photoBtn}>
                <span class="hidden md:block">Add Photo</span>
              </button>
            </div>
          </div>
        </div>
        <div id="photo-upload-form" className="invis">
          <div class="justify-center">
            <div class="rounded-r-lg py-6 cursor-pointer flex items-center justify-center">
              <div class="flex items-center space-x-1 text-gray-900">
